...
Version  : 1.5.1
Release  : 38
URL      : https://cran.r-project.org/src/contrib/fs_1.5.1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/fs_1.5.1.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1638368765
