...
Version  : 1.4.2
Release  : 26
URL      : https://cran.r-project.org/src/contrib/fs_1.4.2.tar.gz
Source0  : https://cran.r-project.org/src/contrib/fs_1.4.2.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1593638653
