...
Version  : 1.6.5
Release  : 60
URL      : https://ftp.osuosl.org/pub/cran/src/contrib/fs_1.6.5.tar.gz
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/fs_1.6.5.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1731642041
