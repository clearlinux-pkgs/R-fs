...
Version  : 1.6.0
Release  : 48
URL      : https://cran.r-project.org/src/contrib/fs_1.6.0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/fs_1.6.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1674497927
